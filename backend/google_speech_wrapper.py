...
GOOGLE_SERVICE_JSON_FILE = r"/home/marian/Projects/Twitch/realtime-transcription-playground/backend/quick-hub-362221-d26b65b471c0.json"
...
class ClientData:
    def __init__(self, transcribe_thread, conn, config: Dict):
        ...
        self._conn = conn
        self.general_config = {
            dict_key: config[dict_key] for dict_key in config if dict_key != "audio"
        }
